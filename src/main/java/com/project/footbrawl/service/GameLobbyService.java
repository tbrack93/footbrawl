...
public class GameLobbyService {
	...
	public GameLobbyService(GameService gs) {
		...
		gs.pitch[3][2].addPlayer(team1Players.get(0));
		gs.pitch[2][2].addPlayer(team2Players.get(0));
		gs.pitch[1][2].addPlayer(team2Players.get(1));
		gs.pitch[1][3].addPlayer(team1Players.get(1));
		gs.pitch[1][1].addPlayer(team1Players.get(2));
