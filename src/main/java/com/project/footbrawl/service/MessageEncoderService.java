...
@Service
public class MessageEncoderService {

	@Autowired
	GameMessageController controller;

	public MessageEncoderService() {

	}
	
	public MessageEncoderService(GameMessageController controller) {
...
public void sendBlitzDetails(int gameId, int player, int opponent, int[] blitzLocation, int[] blitzTarget, 
	...
	public void sendKOResult(int gameId, String teamName, Integer playerId, String playerName, List<Integer> rolled, int needed, String outcome) {
		MessageToClient message = new MessageToClient();
		message.setType("INFO");
	...
	public void sendThrowIn(int gameId, int[] location, int[] target) {
		MessageToClient message = new MessageToClient();
		message.setType("ACTION");
		message.setAction("THROWIN");
		message.setLocation(location);
		message.setTarget(target);
		controller.sendMessageToBothUsers(gameId, message);
	}
